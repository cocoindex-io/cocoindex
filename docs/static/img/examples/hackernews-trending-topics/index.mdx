...
![Building a Real-Time HackerNews Trending Topics Detector with CocoIndex: A Deep Dive into Custom Sources and AI](./cover.png)
...
![HackerNews Cover](./hackernews_cover.png)
...
![HackerNews Index Flow](./flow.png)


## Custom Source

### Defining the Data Model
![HackerNews Data Model](./hackernews.png)
...
![Extract topic from comment](./comment_topic.png)
