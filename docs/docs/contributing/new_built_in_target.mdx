...
description: Learn how to create a new target in CocoIndex.
...
*Users* provide a *Target Spec* when they export specific data (in the form of [Data Collector](/docs/core/data_collector)) to the target.
