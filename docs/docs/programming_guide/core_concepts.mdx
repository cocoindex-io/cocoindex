...
TODO: Consider reorging this section into a) what is memoization, b) why it's needed, c) and when a user might choose either approach described above (is there a best practice? when does it make sense to do one vs the other?)
