...
<img src={useBaseUrl('/img/concept/app.svg')} alt="App diagram" />

For example, here's an app that reads PDFs from a drive, converts them to markdown, and outputs to a folder:

<img src={useBaseUrl('/img/concept/app-example.svg')} alt="App example" />
...
<img src={useBaseUrl('/img/concept/component1.svg')} alt="Processing component" />
...
<img src={useBaseUrl('/img/concept/component2.svg')} alt="Processing component with chunks" />
...
<img src={useBaseUrl('/img/concept/add.svg')} alt="New file added" />
...
<img src={useBaseUrl('/img/concept/update.svg')} alt="File updated" />
...
<img src={useBaseUrl('/img/concept/delete.svg')} alt="File deleted" />
...
<img src={useBaseUrl('/img/concept/memo.svg')} alt="Memoization" />
...
<img src={useBaseUrl('/img/concept/memo1.svg')} alt="Input data update" />
...
<img src={useBaseUrl('/img/concept/memo2.svg')} alt="Code update" />
