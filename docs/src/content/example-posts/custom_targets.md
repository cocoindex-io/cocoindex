...
[→ Target Spec](https://cocoindex.io/docs-v0/custom_ops/custom_targets#target-spec)
...
[→ Target Connector](https://cocoindex.io/docs-v0/custom_ops/custom_targets#target-connector)
