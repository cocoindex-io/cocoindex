...
description: Install Rust, uv, and prek hooks, then build the native extension with maturin develop to get a local CocoIndex checkout ready for development.
meta:
  time: ~15 minutes
  requires: Rust + uv
---
