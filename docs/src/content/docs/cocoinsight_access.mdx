...
description: Start the local CocoIndex HTTP server, then open the CocoInsight web UI to inspect flow schema and data. CocoInsight talks to your server over HTTP and retains no data.
meta:
  time: ~5 minutes
