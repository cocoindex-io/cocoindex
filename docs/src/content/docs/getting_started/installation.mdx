---
title: CocoIndex *installation*
description: pip install cocoindex, start a pgvector-enabled Postgres in Docker, and verify the system requirements (Python 3.11 to 3.13 on macOS, Linux, or Windows).
meta:
  time: ~3 minutes
