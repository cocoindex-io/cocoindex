...
description: Cap rows and bytes in flight at the global, per-source, and per-row layer so CocoIndex stays fast on millions of items without melting your machine.
image: /img/tutorials/control-flow/cover.png
meta:
  time: ~15 minutes
  language: Python 3.11+
---
![Control Processing Concurrency Tuning Guide](/docs-v0/img/tutorials/control-flow/cover.png)
...
![flow-control](/docs-v0/img/tutorials/control-flow/flow-control.png)

You can review the full documentation [here](https://cocoindex.io/docs-v0/core/flow_def#control-processing-concurrency). CocoIndex is powering users process at the scale of millions in production, :star: [star us](https://github.com/cocoindex-io/cocoindex) if you like it!
...
![global-level concurrency](/docs-v0/img/tutorials/control-flow/global-level.png)
...
![per-source concurrency](/docs-v0/img/tutorials/control-flow/per-source.png)
...
![nested-iteration concurrency](/docs-v0/img/tutorials/control-flow/nested-level.png)
...
![tuning-guide](/docs-v0/img/tutorials/control-flow/tuning-guide.png)
