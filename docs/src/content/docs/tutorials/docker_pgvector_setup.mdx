...
- Explore [Query Support](../query) for CocoIndex's built-in query handlers
- Try other [targets](../targets/) like Qdrant, Pinecone, or LanceDB
- Set up [Live Updates](./live_updates) for continuous indexing
