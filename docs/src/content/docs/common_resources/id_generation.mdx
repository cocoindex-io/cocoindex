...
description: >
  Generate IDs and UUIDs that stay stable across incremental runs — generate_id
  and generate_uuid for pure derivation, and IdGenerator / UuidGenerator for
  stateful sequences that still reproduce across runs.
---
