---
title: "*LanceDB* target"
description: Write rows to a LanceDB table with an automatic B-Tree primary-key index, optional FTS indexes, and periodic optimize() calls tuned by a transaction threshold.
