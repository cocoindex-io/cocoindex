---
title: "*Ladybug* target"
description: Talk to a Ladybug API server over HTTP, map collected rows to nodes or relationships, and get an embedded property-graph target with lakehouse-friendly tooling.
toc_max_heading_level: 4
meta:
  language: Python 3.11+
  requires: Ladybug API server
---
...
* `connection` ([auth reference](/docs-v0/core/flow_def#auth-registry) to `LadybugConnectionSpec`): The connection to the Ladybug database. `LadybugConnectionSpec` has the following fields:
