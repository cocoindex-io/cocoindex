---
title: Apache *Doris* target
description: Write rows to Doris tables with vector indexes and full-text search, using Stream Load for bulk ingest and the DUPLICATE KEY model required by Doris 4.0+.
toc_max_heading_level: 4
meta:
  language: Python 3.11+
  requires: Apache Doris 4.0+
---
