...
description: "Postgres, Qdrant, LanceDB, Pinecone, ChromaDB, Doris, Neo4j, Ladybug: pick the vector, relational, or graph store that fits your retrieval workload."
...
|------------------|-------------------------|
| [Postgres](/docs-v0/targets/postgres) | Relational Database, Vector Search (PGVector)   |
| [Qdrant](/docs-v0/targets/qdrant)     | Vector Database, Keyword Search       |
| [LanceDB](/docs-v0/targets/lancedb)   | Vector Database, Keyword Search         |
| [Pinecone](/docs-v0/targets/pinecone) | Vector Database, Keyword Search       |
| [ChromaDB](/docs-v0/targets/chromadb) | Vector Database, Text Search            |
| [Apache Doris](/docs-v0/targets/doris) | Analytical Database, Vector Search, Full-Text Search |
| [Neo4j](/docs-v0/targets/neo4j)       | [Property graph](#property-graph-targets)        |
| [Ladybug](/docs-v0/targets/ladybug)   | [Property graph](#property-graph-targets)  |

If you are looking for targets beyond here, you can always use [custom targets](/docs-v0/custom_ops/custom_targets) as building blocks.
...
If a node label needs to appear as source or target of a relationship, but not exported as a node, you need to [declare](/docs-v0/core/flow_def#target-declarations) the label with necessary configuration.
...
*   Options for [storage indexes](/docs-v0/core/flow_def#storage-indexes).
