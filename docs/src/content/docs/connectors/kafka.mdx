...
description: >
  Consume Kafka topics as live keyed maps (topic_as_map → LiveMapFeed) and
  produce messages as target states — with automatic offset commits and
  partition rebalancing at at-least-once semantics.
---
