---
title: Value *serialization* for memoization
description: >
  How CocoIndex serializes memoized function returns with msgspec — supported
  types (primitives, collections, dataclasses, Pydantic, NumPy), required type
  annotations, custom type registration, and troubleshooting tips.
---
## Overview
