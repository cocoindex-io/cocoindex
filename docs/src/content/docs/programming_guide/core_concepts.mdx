---
title: CocoIndex *core concepts*
description: >
  The mental model behind CocoIndex — declarative state-driven sync, target states,
  Apps, processing components, and how incremental execution skips unchanged work
  across both logic and input changes.
---
import Tabs from '../../../components/Tabs.astro';

import AppOverview from '/src/components/diagrams/concepts/AppOverview.astro';
import AppExample from '/src/components/diagrams/concepts/AppExample.astro';
import ComponentPerFile from '/src/components/diagrams/concepts/ComponentPerFile.astro';
...
<Tabs labels={["On New File Added", "On Existing File Updated", "On Existing File Deleted"]}>
  <Fragment slot="tab-0">
    <ComponentWithChunks scenario={{ rows: [
      { file: 'a.md', chunks: [
      ...
      { file: 'c.md', fileState: 'new', pcState: 'new', splitState: 'new', chunks: [
        { label: 'chunk5', vectorLabel: 'vector5', state: 'new' },
        { label: 'chunk6', vectorLabel: 'vector6', state: 'new' },
      ] },
    ]}} />
  ...
  <Fragment slot="tab-1">
    <ComponentWithChunks scenario={{ rows: [
      ...
      { file: 'b.md', fileState: 'updated', pcState: 'updated', splitState: 'updated', chunks: [
        { label: 'chunk3', vectorLabel: 'vector3', state: 'removed' },
  ...
  <Fragment slot="tab-2">
    <ComponentWithChunks scenario={{ rows: [
      ...
      { file: 'b.md', fileState: 'removed', pcState: 'removed', splitState: 'removed', chunks: [
        { label: 'chunk3', vectorLabel: 'vector3', state: 'removed' },
        { label: 'chunk4', vectorLabel: 'vector4', state: 'removed' },
      ] },
    ]}} />
...
<Tabs labels={["On Input Data Change", "On Code Change"]}>
  <Fragment slot="tab-0">
    <ComponentWithChunks memoized={true} scenario={{ rows: [
      ...
      { file: 'b.md', fileState: 'updated', pcStatus: 'refreshing', pcState: 'updated', splitState: 'updated', chunks: [
  ...
  <Fragment slot="tab-1">
    <ComponentWithChunks memoized={true} scenario={{ rows: [
      { file: 'a.md', pcStatus: 'refreshing', pcState: 'updated', splitState: 'updated', chunks: [
        { label: 'chunk1', vectorLabel: 'vector1', embedStatus: 'cache-ready' },
        { label: 'chunk2', vectorLabel: 'vector2', embedStatus: 'cache-ready' },
      ] },
      { file: 'b.md', pcStatus: 'refreshing', pcState: 'updated', splitState: 'updated', chunks: [
        { label: 'chunk3', vectorLabel: 'vector3', state: 'removed' },
        { label: 'chunk4', vectorLabel: 'vector4', state: 'removed' },
        { label: 'chunk5', vectorLabel: 'vector5', state: 'new' },
        { label: 'chunk6', vectorLabel: 'vector6', state: 'new' },
