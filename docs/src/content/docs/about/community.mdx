...
description: Find the Discord, GitHub, Twitter, LinkedIn, and YouTube channels where the CocoIndex community asks questions, shares ideas, and gets support.
---
...
Check out our [Contributing guide](/docs-v0/contributing/guide) to get started!
:::
...
- Check our [documentation](https://cocoindex.io/docs-v0)
