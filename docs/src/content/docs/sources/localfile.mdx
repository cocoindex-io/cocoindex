...
description: Point at a directory, set glob include and exclude patterns, optionally enable watch_changes, and CocoIndex turns the filesystem into a KTable of filename and content.
