---
title: "*Flow* methods"
description: Once a flow is defined, use the CLI or Python API to set up backends, run one-shot updates, stream live updates, or evaluate the flow without writing to the target.
toc_max_heading_level: 4
meta:
  language: Python 3.11+
---
After a flow is defined as discussed in [Flow Definition](/docs-v0/core/flow_def), you can start to transform data with it.

It can be achieved in two ways:

* Use [CocoIndex CLI](/docs-v0/core/cli).
...
* [Internal storage](/docs-v0/core/basics#internal-storage) for CocoIndex.
...
If you want to remove the flow from the current process, you can call `demo_flow.close()` to do so (see [related doc](/docs-v0/core/flow_def#entry-point)).
