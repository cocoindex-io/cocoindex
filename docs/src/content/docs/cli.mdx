...
description: >
  Reference for the `cocoindex` CLI — app target formats, environment variable
  loading, and subcommands for init, ls, show, update (catch-up or live), and
  drop.
---
...
| `-l, --long` | Display detailed information in table format. |
