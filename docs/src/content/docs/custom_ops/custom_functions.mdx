...
description: Define a custom function as a standalone Python function for simple cases, or as a spec paired with an executor when you need caching, GPU resources, or per-operation setup.
meta:
