...
class ComponentProcessorContext:
    ...
    def use_state(self, key: StableKey, initial_value: Any) -> StoredValue: ...
    def update_user_state(self, key: StableKey, value: Any) -> StoredValue: ...
...
class FnCallContext:
    ...
    def join_child(
        ...
        suppressed_context_deps: set[Fingerprint] | None = None,
    ) -> None: ...
...
# --- Source view (rendered, source-grounded view) ---
class ViewSegment:
    @property
    def start_byte(self) -> int: ...
    @property
    ...
    @property
    def rendered_start(self) -> int: ...
    @property
    def rendered_end(self) -> int: ...
...
class CodeSource:
    def __new__(cls, text: str, language: str | None = None) -> "CodeSource": ...
    @property
    def text(self) -> str: ...
    @property
...
# --- Structural matching over a reusable parsed AST ---
class CodeMatch:
    @property
    def kind(self) -> str: ...
    @property
...
class FileMatch:
    ...
    def path(self) -> str: ...
    @property
    def source(self) -> "CodeSource": ...
    @property
    def matches(self) -> list[CodeMatch]: ...

def match_code(
    pattern: str,
    source: "str | CodeSource",
    language: str | None = None,
) -> list[CodeMatch]: ...
def index_terms(
    source: "str | CodeSource",
