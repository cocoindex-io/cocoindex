...
# --- TurboQuantIdMapIndex ---
class TurboQuantIdMapIndex:
    def __new__(
        cls, dim: int | None = None, bit_width: int = 4
    ) -> TurboQuantIdMapIndex: ...
    def add_with_ids(self, vectors: Any, ids: Any) -> None: ...
    def remove(self, id: int) -> bool: ...
    def search(
        self, queries: Any, k: int, *, allowlist: Any | None = None
    ) -> tuple[Any, Any]: ...
    def contains(self, id: int) -> bool: ...
    def prepare(self) -> None: ...
    def write(self, path: str) -> None: ...
    @classmethod
    def load(cls, path: str) -> TurboQuantIdMapIndex: ...
