...
class FnCallMemoGuard:
    ...
    @property
    def cached_value(self) -> PyValue | None: ...
    @property
    def cached_memo_states(self) -> list[PyValue] | None: ...
...
class ComponentMountRunHandle:
    def result(self, comp_ctx: ComponentProcessorContext) -> PyValue: ...
    async def result_async(self, comp_ctx: ComponentProcessorContext) -> PyValue: ...
...
class UpdateHandle:
    ...
    def result(self) -> Coroutine[Any, Any, PyValue]: ...
